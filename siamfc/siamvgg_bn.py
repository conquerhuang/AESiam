...
from siamfc.backbonesvggnet import VGGNet_bn
...
class TrackerSiamvgg_bn(Tracker):

    def __init__(self, net_path=None, name='Siamvgg', **kwargs):
        super(TrackerSiamvgg_bn, self).__init__(name, True)
        ...
        # setup model
        self.net = Net(
           backbone=VGGNet_bn(),  # out_scale参数，起到对互相关结果加权的作用（互相关的值会很大）
