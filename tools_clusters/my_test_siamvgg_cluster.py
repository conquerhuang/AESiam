...
def evaluate(model_path, tracker_name, experiment):
    tracker = TrackerSiamvgg_cluster(net_path=model_path, name=tracker_name)
...
if __name__ == '__main__':
    ...
    for cluster in range(0, 6):
        for i in range(10, 50):
            model_path = r'../pretrained/cluster' + str(cluster) + '_' + str(i) + '.pth'
            tracker_name = 'cluster' + str(cluster) + '_' + str(i)
            for experiment in experiments:
    ...
    # tracker_infos = []
    #
    # model_path = r'./transformed_model_siamvgg_oc24.pth'
    # tracker_name = 'ESiamFC_oc24'
    # for experiment in experiments:
    #     tracker_infos.append([model_path, tracker_name, experiment])
    # p = Pool(processes=3)
    # for tracker_info in tracker_infos:
