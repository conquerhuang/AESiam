...
from siamfc.backbonesvggnet import VGGNet_oc
...
class TrackerSiamvgg_oc(Tracker):

    def __init__(self, net_path=None, name='Siamvgg', **kwargs):
        super(TrackerSiamvgg_oc, self).__init__(name, True)
        ...
        # setup model
        self.net = Net(
            backbone=VGGNet_oc(),  # out_scale参数，起到对互相关结果加权的作用（互相关的值会很大）
