...
def evaluate(model_path, tracker_name, experiment):
    tracker = TrackerESiamVggAtten(net_path=model_path, name=tracker_name)
...
if __name__ == '__main__':
    ...
    #     model_path = r'../pretrained/ESiamvggAtten_'+ str(i) + '.pth'
    #     tracker_name = 'ESiamvggAtten_' + str(i)
    #     for experiment in experiments:
    ...
    model_path = r'../pretrained/SiamFC/ESiamvggAtten.pth'
